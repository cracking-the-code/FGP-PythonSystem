...
""""class SVR_Model(object):
    ...
    def Train(self):
        ...
        reframed = SVR_Model.__series_to_supervised(dataSet, round(self.__window), 1, False)
        print('REFRAMED')
        print(reframed)
...
class SVR_Model(object):
    ...
    def Train(self):
        ...
        windows                 = dp.ventanaDeslizante(self.__df,1,5)
        print('WINDOWS')
        print(windows)
        train, test             = dp.trainingTestingData(windows,5,1)
        print('TRAIN')
        print(train)
        print('TEST')
        print(test)
        predicted = SVR_Model.__trainModel(train, test)
        print('PREDICTED')
        print(predicted)
